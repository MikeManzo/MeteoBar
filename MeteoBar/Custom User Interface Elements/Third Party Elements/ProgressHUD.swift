...
//  Modified: https://github.com/MikeManzo/ProgressHUD-Mac
//
...
enum ProgressHUDStyle {
    ...
    fileprivate var backgroundColor: NSColor {
        switch self {
        case .light: return NSColor.white.withAlphaComponent(0.75)
        case .dark: return NSColor.black.withAlphaComponent(1.0)
...
class ProgressHUD: NSView {
    ...
    private override init(frame frameRect: NSRect) {
        ...
        window.backgroundColor = NSColor.clear.withAlphaComponent(0.75)
    ...
    private func drawInfoSymbol(frame: NSRect) {
        ...
        func fastFloor(_ xFloor: CGFloat) -> CGFloat { return floor(xFloor) }
...
private class ProgressIndicatorLayer: CALayer {
    ...
    private func createFinLayers() {
        ...
        for index in 0..<numFins {
            ...
            newFin.transform = CATransform3DMakeRotation(CGFloat(index) * (-6.282185 / CGFloat(numFins)), 0.0, 0.0, 1.0)
